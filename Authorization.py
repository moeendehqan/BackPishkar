...
lincensList = {'اطلاعات پایه':['کاربران','مشاوران','مدیریت شعب','بیمه گر','کارمزد استاندارد (آیین نامه)'],
                'اطلاعات حقوق و دستمزد':['گروه های حقوق و دستمزد','حداقل حقوق','کارمزد مشاوران','جدول مالیات'],
                'مدیریت صدور':['افزودن فایل صدور','افزودن دستی صدور','افزودن دستی الحاقیه','تخصیص مشاور صدور'],
